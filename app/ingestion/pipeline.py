...
def collect_events(
    ...
    if mode == "dry":
        ...
        if summary_logging:
            _emit_ingestion_summary(
                ...
                handoff_post_validation_rows=getattr(source_rejected, "handoff_post_validation_rows", 0),
                handoff_post_inconsistent=getattr(source_rejected, "handoff_post_inconsistent", 0),
    ...
    try:
        ...
        if summary_logging:
            ...
            handoff_post_validation_rows = _safe_int(getattr(source_stats, "handoff_post_validation_rows", 0))
            handoff_post_inconsistent = _safe_int(getattr(source_stats, "handoff_post_inconsistent", 0))
            ...
            logger.info(
                ...
                extra={
                    ...
                    "handoff_post_validation_rows": handoff_post_validation_rows,
                    "handoff_post_inconsistent": handoff_post_inconsistent,
                    "exchange_receive_skew_seconds": exchange_receive_skew_seconds,
                    "receive_process_skew_seconds": receive_process_skew_seconds,
                    "invalid_timestamp_total": invalid_timestamp_total,
                    "shadow_row_diff_total": shadow_row_diff_total,
