...
def legacy_market_event_to_trade(
    ...
    *,
    ...
    return TradeEvent(
        ...
        provider_ts=_metadata_ts(metadata, "provider_ts") or event.published_ts,
        receive_ts=receive_ts or _metadata_ts(metadata, "receive_ts") or event.available_ts,
        process_ts=process_ts or _metadata_ts(metadata, "process_ts") or event.processed_ts,
