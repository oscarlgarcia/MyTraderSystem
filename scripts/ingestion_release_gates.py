...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--operational-evidence-path", default="docs/validation/ingestion_operational_evidence.json")
    return parser
...
def main() -> int:
    ...
    report = run_release_gates(
        ...
        operational_evidence_path=Path(args.operational_evidence_path),
