...
FEATURE_EVIDENCE_MANIFEST ?= $(FEATURE_EVIDENCE_DIR)/feature_release_evidence_manifest.json
FEATURE_EVIDENCE_TARGET ?= paper
...
feature-bootstrap-release-inputs:
	$(PYTHON_CMD) scripts/feature_bootstrap_release_inputs.py --env $(FEATURE_ENV) --target $(FEATURE_EVIDENCE_TARGET) --feature-set-name $(FEATURE_SET_NAME) --feature-set-version $(FEATURE_SET_VERSION) --symbol $(FEATURE_SYMBOL) --output-dir $(FEATURE_EVIDENCE_DIR)
...
feature-release-gates:
	$(PYTHON_CMD) scripts/feature_release_gates.py --env $(FEATURE_ENV) --target $(FEATURE_EVIDENCE_TARGET) --parity-path $(FEATURE_EVIDENCE_DIR)/feature_parity_report.json --benchmark-path $(FEATURE_EVIDENCE_DIR)/feature_benchmark_report.json --observability-path $(FEATURE_EVIDENCE_DIR)/feature_observability.json --contract-path $(FEATURE_EVIDENCE_DIR)/feature_contract_validation.json --online-backend http --observability-sink http $(if $(filter live,$(FEATURE_EVIDENCE_TARGET)),--shadow-path $(FEATURE_EVIDENCE_DIR)/feature_shadow_summary.json --soak-path $(FEATURE_EVIDENCE_DIR)/feature_serving_soak.json --concurrency-path $(FEATURE_EVIDENCE_DIR)/feature_serving_concurrency.json --rollout-audit-path $(FEATURE_EVIDENCE_DIR)/feature_rollout_audit.json --evidence-manifest-path $(FEATURE_EVIDENCE_MANIFEST),) --output $(FEATURE_EVIDENCE_DIR)/feature_release_gates.json

feature-paper-promotion:
	$(MAKE) feature-bootstrap-release-inputs FEATURE_EVIDENCE_TARGET=paper
	...
	$(PYTHON_CMD) scripts/feature_live_go_no_go.py --env $(FEATURE_ENV) --target paper --feature-set-name $(FEATURE_SET_NAME) --feature-set-version $(FEATURE_SET_VERSION) --parity-path $(FEATURE_EVIDENCE_DIR)/feature_parity_report.json --benchmark-path $(FEATURE_EVIDENCE_DIR)/feature_benchmark_report.json --observability-path $(FEATURE_EVIDENCE_DIR)/feature_observability.json --contract-path $(FEATURE_EVIDENCE_DIR)/feature_contract_validation.json --gates-output $(FEATURE_EVIDENCE_DIR)/feature_release_gates.json --publish

feature-live-evidence:
	$(MAKE) feature-bootstrap-release-inputs FEATURE_EVIDENCE_TARGET=live
...
feature-live-go-no-go:
	$(PYTHON_CMD) scripts/feature_live_go_no_go.py --env $(FEATURE_ENV) --target live --feature-set-name $(FEATURE_SET_NAME) --feature-set-version $(FEATURE_SET_VERSION) --parity-path $(FEATURE_EVIDENCE_DIR)/feature_parity_report.json --benchmark-path $(FEATURE_EVIDENCE_DIR)/feature_benchmark_report.json --observability-path $(FEATURE_EVIDENCE_DIR)/feature_observability.json --contract-path $(FEATURE_EVIDENCE_DIR)/feature_contract_validation.json --shadow-path $(FEATURE_EVIDENCE_DIR)/feature_shadow_summary.json --soak-path $(FEATURE_EVIDENCE_DIR)/feature_serving_soak.json --concurrency-path $(FEATURE_EVIDENCE_DIR)/feature_serving_concurrency.json --rollout-audit-path $(FEATURE_EVIDENCE_DIR)/feature_rollout_audit.json --evidence-manifest-path $(FEATURE_EVIDENCE_MANIFEST) --gates-output $(FEATURE_EVIDENCE_DIR)/feature_release_gates.json

feature-live-promotion:
	$(PYTHON_CMD) scripts/feature_live_go_no_go.py --env $(FEATURE_ENV) --target live --feature-set-name $(FEATURE_SET_NAME) --feature-set-version $(FEATURE_SET_VERSION) --parity-path $(FEATURE_EVIDENCE_DIR)/feature_parity_report.json --benchmark-path $(FEATURE_EVIDENCE_DIR)/feature_benchmark_report.json --observability-path $(FEATURE_EVIDENCE_DIR)/feature_observability.json --contract-path $(FEATURE_EVIDENCE_DIR)/feature_contract_validation.json --shadow-path $(FEATURE_EVIDENCE_DIR)/feature_shadow_summary.json --soak-path $(FEATURE_EVIDENCE_DIR)/feature_serving_soak.json --concurrency-path $(FEATURE_EVIDENCE_DIR)/feature_serving_concurrency.json --rollout-audit-path $(FEATURE_EVIDENCE_DIR)/feature_rollout_audit.json --evidence-manifest-path $(FEATURE_EVIDENCE_MANIFEST) --gates-output $(FEATURE_EVIDENCE_DIR)/feature_release_gates.json --publish
